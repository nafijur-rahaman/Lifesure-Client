      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          ...
          <motion.div
            ...
            className="lg:col-span-1 rounded-3xl bg-slate-900 p-8 sm:p-12 text-white relative overflow-hidden"
          >
            <ShieldCheck className="h-12 w-12 text-cyan-400" />
            <h3 className="mt-6 text-3xl font-bold">A+ (Superior) Financial Strength</h3>
            ...
            <p className="mt-6 text-sm text-slate-400">Rating affirmed as of July 2025.</p>
            <div className="absolute -bottom-16 -right-16 text-[12rem] font-black text-white/5">
              A+
            </div>
          </motion.div>
          ...
          <motion.div
            variants={itemVariants}
            className="lg:col-span-1 rounded-3xl bg-white p-8 sm:p-12 shadow-2xl ring-1 ring-slate-200/50"
          >
            <img
              src="/trustpilotlogo.png"
              alt="Trustpilot Logo"
              className="h-8"
            />
            <div className="mt-6 flex items-center gap-x-2">
              ...
              <div className="flex">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className={`h-6 w-6 ${i < 4 ? 'text-green-500' : 'text-green-500'}`} fill="currentColor" />
                ))}
              </div>
            </div>
            <p className="mt-2 text-slate-600">Based on 12 reviews</p>
            <blockquote className="mt-6 border-l-4 border-slate-200 pl-6 text-slate-700 italic">
          ...
          <motion.div
            variants={itemVariants}
            className="lg:col-span-2 rounded-3xl bg-slate-50 p-8 sm:p-12 ring-1 ring-slate-200/50"
          >
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
              <AnimatedCounter
                ...
                icon={<ShieldCheck className="h-10 w-10 text-green-500 mx-auto" />}
              />
              <AnimatedCounter
                to={250}
                prefix="+"
                label="families currently protected"
                icon={<Users className="h-10 w-10 text-indigo-500 mx-auto" />}
              />
              <AnimatedCounter
                to={10}
                prefix="<"
                ...
                icon={<TrendingUp className="h-10 w-10 text-cyan-500 mx-auto" />}
              />
            </div>
          </motion.div>
        </motion.div>
