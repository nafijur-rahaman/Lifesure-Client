        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          {user ? (
            <div className="flex items-center gap-3">
              ...
              <a
                href="#"
                className={`rounded-full border px-5 py-2 transition ${theme === "dark" ? "border-gray-600 hover:bg-gray-800" : "border-gray-300 hover:bg-gray-100"}`}
              >
                Logout
              </a>
            </div>
        ...
        <div className={`md:hidden ${dropdownBg} shadow-lg px-6 py-4 flex flex-col gap-4 animate-slideDown`}>
          {navLinks.map((link) =>
            link.dropdown ? (
              ...
              >
                <summary
                  className={`flex items-center justify-between cursor-pointer font-medium transition ${active === link.name ? "text-indigo-600" : textColor} ${hoverTextColor}`}
                >
                  {link.name}
                  <ChevronDown
                    className={`w-4 h-4 transition group-open:rotate-180 ${openDropdown === link.name ? "rotate-180" : ""}`}
                  />
                </summary>
          ...
          <div className="flex flex-col gap-3 mt-4">
            {user ? (
              <>
                ...
                <a
                  href="#"
                  className={`rounded-full border px-5 py-2 text-center transition ${theme === "dark" ? "border-gray-600 hover:bg-gray-800" : "border-gray-300 hover:bg-gray-100"}`}
                  onClick={() => setIsOpen(false)}
                >
                  Logout
                </a>
